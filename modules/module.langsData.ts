...
const languages: LanguageItem[] = [
  ...
  { cr_locale: 'es-LA',  locale: 'es-419', code: 'spa',     name: 'Spanish',                   language: 'Spanish (Latin American) / Español (América Latina)', hidive_audio_code: 'spa'},
  { cr_locale: 'es-419', locale: 'es-419', code: 'spa-419', name: 'Spanish (Latin American)',  language: 'Español (América Latina)', new_hd_locale: 'es-MX', ao_locale: 'es-419', hidive_audio_code: 'spa'    },
  { cr_locale: 'es-ES',  locale: 'es-ES',  code: 'spa-ES',  name: 'Spanish',                   language: 'Español (España)'        },
  { cr_locale: 'fr-FR',  locale: 'fr-FR',  code: 'fre',     name: 'French',                    language: 'Français (France)',  hd_locale: 'French', adn_locale: 'fr-FR', hidive_audio_code: 'fre'      },
  { cr_locale: 'pt-BR',  locale: 'pt-BR',  code: 'por',     name: 'Portuguese (Brazilian)',    language: 'Português (Brasil)', new_hd_locale: 'pt-BR', ao_locale: 'pt-BR', hidive_audio_code: 'por'              },
  { cr_locale: 'pt-PT',  locale: 'pt-PT',  code: 'por',     name: 'Portuguese (European)',     language: 'Português (Portugal)',  },
  { cr_locale: 'ar-ME',  locale: 'ar-ME',  code: 'ara',     name: 'Arabic',                    language: 'العربية',              },
  { cr_locale: 'ar-SA',  locale: 'ar-SA',  code: 'ara',     name: 'Arabic (Saudi Arabia)',     language: 'العربية',      hd_locale: 'Arabic',             },
  { cr_locale: 'it-IT',  locale: 'it-IT',  code: 'ita',     name: 'Italian',                   language: 'Italiano',      hd_locale: 'Italian',       hidive_audio_code: 'ita'     },
  { cr_locale: 'de-DE',  locale: 'de-DE',  code: 'ger',     name: 'German',                    language: 'Deutsch',       hd_locale: 'German',        hidive_audio_code: 'ger'     },
  { cr_locale: 'ru-RU',  locale: 'ru-RU',  code: 'rus',     name: 'Russian',                   language: 'Русский',       hd_locale: 'Russian',       hidive_audio_code: 'rus'        },
  { cr_locale: 'tr-TR',  locale: 'tr-TR',  code: 'tur',     name: 'Turkish',                   language: 'Türkçe',        hd_locale: 'Turkish',              },
  ...
  { cr_locale: 'ko-KR',  locale: 'ko-KR',  code: 'kor',     name: 'Korean',                    language: '한국어',           hd_locale: 'Korean',          },
  { cr_locale: 'ja-JP',  locale: 'ja-JP',  code: 'jpn',     name: 'Japanese',                  language: 'Japanese',        ao_locale: 'ja-JP',  adn_locale: 'ja-JP', hd_locale: 'Japanese', hidive_audio_code: 'jpn'   },
];
