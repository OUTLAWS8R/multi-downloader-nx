...
const fontFamilies = {
  ...
  'Adobe Arabic Bold Italic': ['Adobe_Arabic_Bold_Italic.otf'],
  ...
  'Attic': ['Attic.ttf'],
  'Attic Bold': ['Times_Old_Attic_Bold.ttf'],
  'Bahnschrift': ['bahnschrift.ttf'],
  'Bahnschrift Light': ['bahnschrift.ttf'],
  'BakerSignet BT': ['BakerSignet_Roman.ttf'],
  'BakerSignet BT Bold': ['Baker_Signet_BT.ttf'],
  ...
  'Book Antiqua Bold': ['Book_Antiqua_Bold.ttf'],
  ...
  'Caviar Dreams Bold': ['CaviarDreams_Bold.ttf'],
  'Caviar Dreams Bold Italic': ['CaviarDreams_BoldItalic.ttf'],
  'Caviar Dreams Italic': ['CaviarDreams_Italic.ttf'],
  'CentSchbook BT': ['CenturySchoolbookBT.ttf'],
  'CentSchbook BT Bold': ['CenturySchoolbookBoldBT.ttf'],
  'Consolas': ['Consola.ttf'],
  'Consolas Bold': ['Consolab.ttf'],
  'Consolas Bold Italic': ['Consolaz.ttf'],
  'Consolas Italic': ['Consolai.ttf'],
  'Constantia': ['Constantia_Regular.ttf'],
  ...
  'DomCasual BT': ['dom-casual.ttf'],
  'DomCasual BT Bold': ['domcasn_bt_bold.ttf'],
  ...
  'Freehand471 BT Bold': ['FRHND471.ttf'],
  'Freehand471 BT Italic': ['FRHND471.ttf'],
  'Freehand471 BT Bold Italic': ['FRHND471.ttf'],
  'Gautami': ['Gautami.ttf'],
  'Gabriola': ['Gabriola.ttf'],
  'Garamond': ['Garamond_Regular.ttf'],
  'Garamond Bold': ['Garamond_Bold.ttf'],
  'Georgia': ['georgia.ttf'],
  ...
  'Komika Title Axis': ['KomikaTitle-Axis.ttf'],
  ...
  'Open Sans Extrabold Italic': ['OpenSans-ExtraBoldItalic.ttf'],
